...
<body>
                                ...
                                <div class="data-tables">
                                    <table id="dataTable" class="table table-hover progress-table text-center">
                                       ...
                                       <tr>
                                           ...
                                           <td><?php echo htmlentities($result->AdminRemark ? ($result->AdminRemark . " at " . $result->AdminRemarkDate) : 'Pending'); ?></td>
                                           <td>
                                               <?php 
                                               $stats = $result->Status;
                                               if ($stats == 1) {
                                           ...
                                           <td>
                                               <button class="btn btn-primary btn-sm" onclick="printLeaveDetails('<?php echo $result->LeaveType; ?>', '<?php echo $result->FromDate; ?>', '<?php echo $result->ToDate; ?>', '<?php echo $result->Description; ?>', '<?php echo $result->PostingDate; ?>', '<?php echo htmlentities($result->AdminRemark); ?>', '<?php echo htmlentities($result->AdminRemarkDate); ?>', '<?php echo $stats; ?>')">Print</button>
                                           </td>
                                       </tr>
                                         <?php $cnt++;} }?>
    ...
    <script>
    function printLeaveDetails(type, fromDate, toDate, description, postingDate, adminRemark, remarkDate, status) {
        ...
        const printContent = `
            <div style="font-family: Arial, sans-serif; text-align: left;">
                ...
                <p><strong>Applied On:</strong> ${postingDate}</p>
                <p><strong>Admin's Remark:</strong> ${adminRemark ? adminRemark : 'Pending'}</p>
                <p><strong>Remark Date:</strong> ${remarkDate ? remarkDate : 'N/A'}</p>
                <p><strong>Status:</strong> ${status == 1 ? 'Approved' : (status == 2 ? 'Not Approved' : 'Pending')}</p>
            </div>
        `;
