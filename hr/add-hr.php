<?php
    ...
    $sql="INSERT INTO tblhr(Empid,FirstName,LastName,EmailId,Password,Gender,Dob,Department,unit,Address,City,Country,Phonenumber,Status) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:unit,:address,:city,:country,:mobileno,:status)";
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Add HR Section</h4>
                            <ul class="breadcrumbs pull-left"> 
                                <li><a href="employees.php">HR</a></li>
                                <li><span>Add</span></li>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" name="unit" autocomplete="off">
                                                <option value="">Choose..</option>
                                                <option value="Directors and Deputies">Directors and Deputies</option>
                                        ...
                                        <h4>Set Password for HOD Login</h4>
