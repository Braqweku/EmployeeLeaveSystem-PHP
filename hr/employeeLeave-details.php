...
$query->bindValue(':isread', $isread, PDO::PARAM_STR);  // Use bindValue
$query->bindValue(':did', $did, PDO::PARAM_STR);  // Use bindValue
$query->execute();
    try {
        $query->execute();
    } catch (Exception $e) {
    ...
    if(isset($_POST['update'])){ 
        ...
        if(empty($description) || empty($status)) {
            $error = "Both description and status are required.";
        } else {
            if($status == '1'){
                $activateadmin = '0';
                $mainStatus = '0';
            ...
            $sql = "UPDATE tblleaves set AdminRemark=:description, Status=:mainStatus, HRStatus=:status, AdminStatus=:activateadmin, AdminRemarkDate=:admremarkdate where id=:did";
            $query = $dbh->prepare($sql);
            $query->bindValue(':description', $fromwho .= $description, PDO::PARAM_STR);
            $query->bindValue(':status', $status, PDO::PARAM_STR);
            $query->bindValue(':admremarkdate', $admremarkdate, PDO::PARAM_STR);
            $query->bindValue(':did', $did, PDO::PARAM_STR);
            $query->bindValue(':mainStatus', $mainStatus, PDO::PARAM_STR);
            $query->bindValue(':activateadmin', $activateadmin, PDO::PARAM_STR);
            try {
                $query->execute();
...
<head>
    ...
    <style>
        ...
        .header-images img {
            position: absolute; /* Allow image placement */
            width: 100px; /* Adjust image size */
            height: auto; /* Maintain aspect ratio */
        }

        /* Specific styles for the images */
...
<body>
    ...
    <div class="header-images">
        <img src="../assets/images/4.png" alt="Left Image"> <!-- Replace with your image path -->
        <img src="../assets/images/2.png" alt="Right Image"> <!-- Replace with your image path -->
    </div>
        ...
        <div class="sidebar-menu">
            ...
            <div class="main-menu">
                <div class="menu-inner">
                    <?php $page="employee";
                    include '../includes/hr-sidebar.php'
                    ?>
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">HR<i class="fa fa-angle-down"></i></h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td colspan="12"><?php
if (!empty($result->HODRemark)) { ?>
    <tr>
        <td><b>HOD Remark:</b></td>
        <td colspan="3"><?php echo htmlentities($result->HODRemark); ?></td>
    </tr>
<?php } else { ?>
    <tr>
        <td><b>HOD Remark:</b></td>
        <td colspan="3">No remark available.</td>
    </tr>
                                <tr>
