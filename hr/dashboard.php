                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>HR's Dashboard</span></li>
                            </ul>
                        </div>
                    </div>
                                        ...
                                        <div class="single-table">
                                            <div class="table-responsive">
                                                ...
                                                <?php 
                                                    ...
                                                    $sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status,tblleaves.HRStatus from tblleaves join tblemployees on tblleaves.empid=tblemployees.id WHERE 
    tblleaves.HRStatus <> '' order by lid desc limit 7";
