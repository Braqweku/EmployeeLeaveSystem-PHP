...
onclick="printLeaveDetails('<?php echo htmlentities($result->lid); ?>')">
Print
</button>
</td>
                                        </tr>
...
function printLeaveDetails(leaveId) {
    // Construct the URL for the leave details page
    const url = `employeeLeave-details.php?leaveid=${leaveId}`;
    
    // Open the leave details page in a new tab
    ...
    if (printWindow) {
        ...
        printWindow.onload = function () {
            ...
            }, 2000); // Wait for 2 seconds before printing
        };
    } else {
