<?php
    ...
    $sql="INSERT INTO tblhod(Empid,FirstName,LastName,EmailId,Password,Gender,Dob,Department,unit,Address,City,Country,Phonenumber,Status) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:unit,:address,:city,:country,:mobileno,:status)";
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left"> 
                                <li><a href="employees.php">HOD</a></li>
                                <li><span>Add</span></li>
