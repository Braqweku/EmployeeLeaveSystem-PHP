                                        ...
                                        <div class="single-table">
                                            <div class="table-responsive">
                                                ...
                                                <?php 
                                                    ...
                                                    $sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminStatus from tblleaves join tblemployees on tblleaves.empid=tblemployees.id WHERE 
    tblleaves.AdminStatus <> '' order by lid desc limit 7";
