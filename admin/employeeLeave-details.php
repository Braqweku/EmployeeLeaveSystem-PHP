<?php
    ...
    $query->bindValue(':isread',$isread,PDO::PARAM_STR);
    ...
    $sql="UPDATE tblleaves set AdminRemark=:description,Status=:status,AdminStatus=:status,AdminRemarkDate=:admremarkdate where id=:did";
    $query = $dbh->prepare($sql);
